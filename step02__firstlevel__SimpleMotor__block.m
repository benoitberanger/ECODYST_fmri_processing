...
model_name = 'SimpleMotor_block';

dirStats = e.mkdir('glm',model_name);
dirFunc  = get_parent_path( e.getSerie('run_SimpleMotor').getVolume('s5wts').toJob() );
...
e.getSerie('run_MentalRotation').addStim(onsetspath, 'SimpleMotor.mat', model_name)
