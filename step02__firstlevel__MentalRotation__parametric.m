...
model_name = 'MentalRotation_parametric';
...
e.getSerie('run_MentalRotation').addStim(onsetspath, 'MentalRotation_run01_SPM_parametric.mat', model_name)
...
Rest                             = [1 0 0 0 0 0 0];
Trial                            = [0 1 0 0 0 0 0];
Trialxcondition__sameM1_mirrorP1 = [0 0 1 0 0 0 0];
Trialxangle                      = [0 0 0 1 0 0 0];
TrialxRT                         = [0 0 0 0 1 0 0];
Trialxsubjresp__sameM1_mirrorP1  = [0 0 0 0 0 1 0];
Trialxrespok                     = [0 0 0 0 0 0 1];

contrast_T.values = {
    
Rest
Trial
+Trialxcondition__sameM1_mirrorP1
-Trialxcondition__sameM1_mirrorP1
+Trialxangle
-Trialxangle
+TrialxRT
-TrialxRT
+Trialxsubjresp__sameM1_mirrorP1
-Trialxsubjresp__sameM1_mirrorP1
+Trialxrespok
-Trialxrespok
